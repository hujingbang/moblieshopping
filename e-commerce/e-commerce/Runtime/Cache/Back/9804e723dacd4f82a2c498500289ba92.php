...
<form action="/admin.php/Index/modifygoods" method="post" enctype="multipart/form-data">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-3" style="margin-top: 25px;">
				<div class="input-group">
				  ...
				  <input type="text" class="form-control" name="goodsname" value="<?php echo ($goodsnameoldvalue); ?>">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4 col-md-offset-3" style="margin-top: 25px;">
				<div class="input-group">
				  ...
				  <input type="text" class="form-control" name="goodsprice" value="<?php echo ($goodspriceoldvalue); ?>">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4 col-md-offset-3" style="margin-top: 25px;">
				<div class="input-group">
				  ...
				  <input type="text" class="form-control" name="goodsweight" value="<?php echo ($goodsweightoldvalue); ?>">
				</div>
			</div>
		</div>
		<div class="row">
			  <div class="col-xs-6 col-md-3 col-md-offset-3"  style="margin-top: 25px;">
			      <img src="<?php echo ($goodsoldurl); ?>" width="170" height="180" id="goodsimg">
			  </div>
		</div>
		<div class="row">
			...
			<script type="text/javascript">
				...
				function UrlUpload(uploadgoodsimg){
					if(uploadgoodsimg.files.length == 0 ) {

						$("#goodsimg").attr("src","/Back/Public/images/uploadgoods.png");
					} else {
			...
			<div class="row">
				<input type="submit" name="modifygoods" value="修改" class="btn btn-info col-md-3 col-md-offset-3" >
			</div>
	</div>
</form>
		</div>
